...
Recipes depend on `@agentstack/sdk@0.4.18`. **Never auto-run `npm install`** from agents or CI without explicit human approval — document flows only.
...
node path/to/genetic-ai-starter/scripts/submodule-add-sdk.mjs --target . --tag v0.4.18
