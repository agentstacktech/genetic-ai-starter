# Documentation hub — Genetic AI Starter Kit

**Genetic tag:** `repo.tooling.genetic_starter.docs.gen1`

Documentation for **installing and using** the kit in your project. Operator-only material (npm publish, mirror sync, internal audits) lives in the AgentStack monorepo under `docs/genetic-ai-starter-maintainers/` and is **not** part of the public kit repository mirror.
...
| **Scale / inventory** | **[PLATFORM_SCALE_DIGEST.md](PLATFORM_SCALE_DIGEST.md)** · [_ru](PLATFORM_SCALE_DIGEST_ru.md) · [GENETIC_SCALE_METRICS_DECOMPOSITION.md](GENETIC_SCALE_METRICS_DECOMPOSITION.md) · [platform-stats.snapshot.json](platform-stats.snapshot.json) |
...
| **AgentStack consumer** | **[AGENTSTACK_APP_GUIDE.md](AGENTSTACK_APP_GUIDE.md)** · [RU](AGENTSTACK_APP_GUIDE_ru.md) · **[PLUGIN_INSTALL.md](PLUGIN_INSTALL.md)** · [RULES_PLUGIN_KIT_MATRIX.md](RULES_PLUGIN_KIT_MATRIX.md) |
...
| **Agent floor** | [AGENT_FLOOR_ru.md](AGENT_FLOOR_ru.md) · [EN](AGENT_FLOOR.md) |
| Architecture | [NAVIGATION_OS.md](NAVIGATION_OS.md) · [KIT_ARCHITECTURE.md](KIT_ARCHITECTURE.md) · [AGENTSTACK_EXTENSION.md](AGENTSTACK_EXTENSION.md) |
| Repositories | [REPOSITORY_LINKS.md](REPOSITORY_LINKS.md) |

## Narrative

| Doc | Topic |
|-----|-------|
| [BENEFITS_AND_METRICS.md](BENEFITS_AND_METRICS.md) | Metrics EN |
| [BENEFITS_AND_METRICS_ru.md](BENEFITS_AND_METRICS_ru.md) | Metrics RU |
| [REAL_BENEFITS_ru.md](REAL_BENEFITS_ru.md) | Value narrative RU |
| [REAL_BENEFITS.md](REAL_BENEFITS.md) | Value narrative EN |
| [AI_RELEASE_AUTONOMY_ru.md](AI_RELEASE_AUTONOMY_ru.md) | Release with AI |
| [AI_RELEASE_AUTONOMY.md](AI_RELEASE_AUTONOMY.md) | Release EN |
| [GENE_ADAPTATION.md](GENE_ADAPTATION.md) | Genes and mistakes |
...
| Analysis | [benchmarks/results/ANALYSIS.md](../../benchmarks/results/ANALYSIS.md) |
| Tokens | [benchmarks/results/TOKEN_REPORT.md](../../benchmarks/results/TOKEN_REPORT.md) |
| Onboarding sample | [BENCHMARK_ONBOARDING_SAMPLE.md](BENCHMARK_ONBOARDING_SAMPLE.md) |
...
| FAQ | [FAQ.md](../../FAQ.md) · [FAQ_ru.md](../../FAQ_ru.md) |
| Community | [COMMUNITY.md](../../COMMUNITY.md) · [COMMUNITY_ru.md](../../COMMUNITY_ru.md) |
| Showcase | [SHOWCASE.md](../../SHOWCASE.md) |

## Contributing to the kit

See [CONTRIBUTING.md](../../CONTRIBUTING.md) and [MAINTAINERS.md](../../MAINTAINERS.md). Release/mirror/npm checklists are **not** in this public doc tree.
