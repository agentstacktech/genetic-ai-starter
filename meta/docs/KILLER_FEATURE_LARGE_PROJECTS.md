...
Monorepo lattice size: [platform-stats.snapshot.json](platform-stats.snapshot.json) (**498** genes, **244** repo / **219** platform `AI_INDEX`, **546** Tier-1 tags). Separate from shop-api harness below.
